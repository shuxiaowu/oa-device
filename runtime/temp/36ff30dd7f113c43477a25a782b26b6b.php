            ...
            <form name="adminform" method="post" action="" onSubmit="return sysassets(document.adminform)">
                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="table tablevh">
                    <tr>
                        ...
                        <td width="200" align="left"><?php echo inputs(array('name'=>'fcreson','place'=>'封存事由','val'=>$data['fcreson'],'width'=>'20')); ?> </td>
                        <td width="120" align="right" valign="middle">日期<font class="addred">*</font>：</td>
                        <td align="left"><?php echo inputs(array('name'=>'addtime','val'=>$data['addtime'],'add'=>'input-date','place'=>'日期','width'=>'20')); ?></td>
                    </tr>
                    <tr>
                        <td width="120" align="right" valign="middle">经办人<font class="addred">*</font>：</td>
                        <td align="left"> <?php echo inputs(array('name'=>'agent','place'=>'经办人','val'=>$data['agent'],'width'=>'20')); ?> </td>
                       <!--  <td width="120" align="right" valign="middle">封存事由<font class="addred">*</font>：</td>
                        <td width="200" align="left"><?php echo inputs(array('name'=>'fcreson','place'=>'封存事由','val'=>$data['fcreson'],'width'=>'20')); ?> </td> -->
                        <td width="120" align="right" valign="middle">封存期限<font class="addred">*</font>：</td>
                        <td align="center"><?php echo inputs(array('name'=>'fcdatestart','add'=>'input-date','val'=>datem(),'place'=>'起始','width'=>'20')); ?>至<?php echo inputs(array('name'=>'fcdateend','add'=>'input-date','val'=>datem(),'place'=>'结束','width'=>'20')); ?>
                         </td>
                    </tr>
                    <tr>
                        <td width="120" align="right" valign="middle">封存图片<font class="addred">*</font>：</td>
                        <td align="left"> <?php echo uppicture($data['fcpic'],'图片上传',1,'fcpic'); ?> </td>
                    </tr>
                    <tr>
