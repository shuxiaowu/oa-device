    ...
    <div class="pubmain" style="min-width:2800px;">
        <div class="panel-body">
            <div class="u-plus btn-group">
            	<?php if($userid != 1): ?>
                 <?php echo btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/assetsadd'))); endif; ?>
    ...
    <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
        ...
        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
            <tr class="maintr">
                ...
                <td align="center" valign="middle"><?php echo $obj['licensenum']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['brand']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['displacement']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['cartype']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['seat']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['price']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['distance']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['alldistance']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['jiayouc']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['gantongc']; ?></td>
                <td align="center" valign="middle"><?php echo showdate($obj['safedate']); ?></td>
                <td align="center" valign="middle"><?php echo $obj['safeprice']; ?></td>
                <td align="center" valign="middle"><?php echo $obj['purpose']; ?></td>
