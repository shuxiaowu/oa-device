<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\chukulist.tpl";i:1555407071;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
  ...
  <div class="pubmain" style="min-width:1200px;">
    <div class="panel-body">
      <div class="u-plus btn-group">
        <?php echo btn(array('vals'=>'新建领用单','size'=>3,'scene'=>'primary','url'=>url('assets/chukuadd'))); ?>
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
          ...
          <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
            <tr class="maintr">
             ...
             <td align="center" valign="middle"><?php echo $obj['danhao']; ?></td>
             <td align="center" valign="middle"><?php echo $obj['branch']; ?></td>
             <td align="center" valign="middle"><?php echo $obj['recipient']; ?></td>
             <td align="center" valign="middle"><?php echo $obj['applydate']; ?></td>
             <td align="center" valign="middle"><?php echo $obj['remark']; ?></td>
             <td align="center" valign="middle"><?php echo $obj['state']; ?></td>
             <td align="center" valign="middle"><?php echo $obj['lingdate']; ?></td>
             <td align="center" valign="middle"><?php echo $obj['guihuan']; ?></td>
              <td align="center" valign="middle">
                <?php echo btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/chukumod','id='.$obj['Id']))); ?>
