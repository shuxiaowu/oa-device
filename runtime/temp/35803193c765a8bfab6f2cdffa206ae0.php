<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\sysupload.tpl";i:1542630568;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <div class="pubmain">
  ...
  <div class="btn-group">
   ...
   <?php echo btn(array('vals'=>'上传设置','size'=>3,'icon'=>'paperclip','scene'=>'primary','url'=>url('system/sysupload'))); ?>
  ...
  <form name="sysmod" method="post" action="" onSubmit="return sysck(document.sysmod)">
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="<?php echo tabstyle(); ?>">
      <tr>
        ...
        <td height="42" align="left"><?php echo inputs(array('name'=>'picsize','val'=>$data['picsize'],'units'=>'kb','tips'=>'上传的文件大小限制 (0-不做限制)，单位kb，最大值取决于php.ini允许的最大值','width'=>'15')); ?></td>
      </tr>
      <tr>
        <td width="132" height="42" align="right" valign="middle">图片上传后缀：</td>
        <td height="42" align="left"><?php echo inputs(array('name'=>'picsuffix','val'=>$data['picsuffix'],'icon'=>'paperclip','tips'=>'多个以英文逗号隔开','width'=>'45')); ?></td>
      </tr>
      <tr>
        ...
        <td height="42" align="left">
         ...
         <?php echo inputs(array('name'=>'picmaxwidth','val'=>$data['picmaxwidth'],'units'=>'px','tips'=>'当图片宽度大于该值的时候，自动裁剪。 0表示不进行操作！ 单位 px','width'=>'15')); ?>
         <?php echo inputs(array('name'=>'picmaxsize','val'=>$data['picmaxsize'],'units'=>'MB','tips'=>'当图片容量大小大于该值的时候，自动裁剪。 0表示不进行操作！单位 MB','width'=>'15')); ?>
        </td>
      </tr>
      <tr>
        <td width="132" height="42" align="right" valign="middle">图片裁剪宽度：</td>
        <td height="42" align="left">
         <?php echo inputs(array('name'=>'cropwidth','val'=>$data['cropwidth'],'units'=>'px','tips'=>'裁剪的宽度','width'=>'15')); ?>
        </td>
      </tr>
      <tr>
        <td width="132" height="42" align="right" valign="middle">附件上传大小：</td>
        <td height="42" align="left"><?php echo inputs(array('name'=>'filesize','val'=>$data['filesize'],'units'=>'kb','tips'=>'上传的文件大小限制 (0-不做限制)，单位kb，最大值取决于php.ini允许的最大值','width'=>'15')); ?></td>
      </tr>
      <tr>
        <td width="132" height="42" align="right" valign="middle">附件上传后缀：</td>
        <td height="42" align="left"><?php echo inputs(array('name'=>'filesuffix','val'=>$data['filesuffix'],'icon'=>'paperclip','tips'=>'多个以英文逗号隔开','width'=>'45')); ?></td>
      </tr>
      <tr>
