<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\assetslist.tpl";i:1555723237;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
  ...
  <div class="pubmain" style="min-width:2800px;">
    <div class="panel-body">
      <div class="u-plus btn-group">
        <?php echo btn(array('vals'=>'新增资产','size'=>3,'scene'=>'primary','url'=>url('assets/assetsadd'))); ?>
       ...
       <?php echo btn(array('vals'=>'导出全部资产','size'=>3,'scene'=>'default','add'=>'printzc')); ?>
       <?php echo btn(array('vals'=>'打印资产标签','size'=>3,'scene'=>'default','add'=>'printzc')); ?>
     </div>
     <form name="pubserch" method="get" action="<?php echo url('assets/assetslist'); ?>">
      <div class="search"> 资产编码/名称：
        <input type="text" class="text" name="name" placeholder="资产编码/名称/SN号" style="width:180px;">
        资产类目：<?php echo dropdown([['Id'=>1,'topic'=>'闲置资产'],['Id'=>2,'topic'=>'维护资产'],['Id'=>3,'topic'=>'报废资产']],0,'请选择','state'); ?>
        ...
        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
          <tr class="maintr">
            ...
            <td align="center" valign="middle">
             <?php if($obj['state'] == 1): ?><font color="green">闲置</font><?php endif; if($obj['state'] == 2): ?><font color="#ff6600">维修</font><?php endif; if($obj['state'] == 3): ?><font color="red">报废</font><?php endif; ?>
           </td>
           <td align="center" valign="middle"><?php echo $obj['devno']; ?></td>
           <td align="center" valign="middle"><?php echo $obj['devname']; ?></td>
           <td align="center" valign="middle"><?php echo getdata('assetstype',$obj['devtype']); ?></td>
           <td align="center" valign="middle"><?php echo $obj['rkdate']; ?></td>
           <td align="center" valign="middle"><?php echo $obj['brand']; ?></td>
           <td align="center" valign="middle"><?php echo getdata('assetssource',$obj['source']); ?></td>
           <td align="center" valign="middle"><?php echo $obj['devxh']; ?></td>
           <td align="center" valign="middle"><?php echo $obj['channel']; ?></td>
           <td align="center" valign="middle"><?php echo $obj['price']; ?></td>
           <td align="center" valign="middle"><?php echo $obj['buydate']; ?></td>
           <td align="center" valign="middle"><?php echo $obj['uselimit']; ?>月</td>
           <td align="center" valign="middle"><?php echo $obj['sn']; ?></td>
           <td align="center" valign="middle"><?php echo $obj['bxsdate']; ?></td>
           <td align="center" valign="middle"><?php echo $obj['bxedate']; ?></td>
           <td align="center" valign="middle"><?php if($obj['pic'] != ''): ?><img src="<?php echo ispic($obj['pic']); ?>" data-action="zoom" height="20"><?php else: ?>无<?php endif; ?></td>
           <td align="center" valign="middle">--</td>
           <td align="center" valign="middle">--</td>
           <td align="center" valign="middle">--</td>
           <td align="center" valign="middle">--</td>
           <td align="center" valign="middle"><?php echo $obj['units']; ?> </td>
           <td align="center" valign="middle">
            <?php echo btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/assetsmod','id='.$obj['Id']))); ?>
            <?php echo btn(array('vals'=>'删除','icon'=>'trash','round'=>1,'tips'=>'点击删除数据','scene'=>'danger')); ?>
          </td>
        </tr>
