<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\pdlist.tpl";i:1554802400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
  ...
  <div class="pubmain" style="min-width:1400px;">
    <div class="panel-body">
      <div class="u-plus btn-group">
        <?php echo btn(array('vals'=>'新建盘点任务','size'=>3,'scene'=>'primary','url'=>url('assets/pdadd'))); ?>
      </div>
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
          ...
          <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
            <tr class="maintr">
              ...
              <td align="center" valign="middle"><?php echo $obj['sdate']; ?></td>
              <td align="center" valign="middle"><?php echo $obj['edate']; ?></td>
              <td align="center" valign="middle"><?php echo getdata('adminuser',$obj['adminuid'],'realname'); ?></td>
              <td align="center" valign="middle">
               <?php if($obj['state'] == 1): ?><font color="red">待完成</font><?php endif; if($obj['state'] == 2): ?><font color="green">已完成</font><?php endif; ?>
              </td>
              <td align="center" valign="middle"><?php echo $obj['remark']; ?></td>
              <td align="left" valign="middle">
                <?php echo btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/pdmod','id='.$obj['Id']))); ?>
                <?php echo btn(array('vals'=>'删除','icon'=>'trash','round'=>1,'tips'=>'点击删除数据','scene'=>'danger')); ?>
                <?php echo btn(array('vals'=>'结果','faicon'=>'list','round'=>1,'tips'=>'点击查看盘点结果','scene'=>'success','url'=>url('assets/pdresult','sn='.$obj['sn']))); ?>
              </td>
            </tr>
