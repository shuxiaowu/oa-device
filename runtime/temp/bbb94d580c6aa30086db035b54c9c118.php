<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\assetsadd.tpl";i:1555380088;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
      ...
      <form name="adminform" method="post" action="" onSubmit="return sysassets(document.adminform)">
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="table tablevh">
          <tr>
            ...
            <td width="200" align="left"><?php echo inputs(array('name'=>'devno','place'=>'请输入资产编码','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">资产名称<font class="addred">*</font>：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'devname','place'=>'请输入资产名称','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">资产类别<font class="addred">*</font>：</td>
            <td align="left"><?php echo searchField(['tables'=>'assetstype','field'=>'topic','s_field'=>'topic','name'=>'devtype','width'=>200,'default'=>'请选择资产类别']); ?></td>
          </tr>
          <tr>
            <td width="120" height="32" align="right" valign="middle">入库时间<font class="addred">*</font>：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'rkdate','add'=>'input-date','place'=>'选择入库时间','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">型号：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'devxh','place'=>'请输入型号','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">计量单位：</td>
            <td align="left"> <?php echo inputs(array('name'=>'units','place'=>'请输入计量单位','width'=>'20')); ?> </td>
          </tr>
          <tr>
            <td width="120" height="32" align="right" valign="middle">来源<font class="addred">*</font>：</td>
            <td width="200" align="left"><?php echo searchField(['tables'=>'assetssource','field'=>'topic','s_field'=>'topic','name'=>'source','width'=>200,'default'=>'请选择来源']); ?></td>
            <td width="120" align="right" valign="middle">渠道：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'channel','place'=>'请输入渠道','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">金额：</td>
            <td align="left"> <?php echo inputs(array('name'=>'price','place'=>'请输入金额','width'=>'20')); ?> </td>
          </tr>
          <tr>
            <td width="120" height="32" align="right" valign="middle">品牌<font class="addred">*</font>：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'brand','place'=>'请输入品牌','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">购入时间<font class="addred">*</font>：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'buydate','add'=>'input-date','place'=>'请选择购入时间','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle"> 使用期限：</td>
            <td align="left"> <?php echo inputs(array('name'=>'uselimit','place'=>'请输入使用期限','units'=>'月','width'=>'20')); ?> </td>
          </tr>
          <tr>
            <td width="120" height="32" align="right" valign="middle">SN号：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'sn','place'=>'SN号','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">保修起始：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'bxsdate','add'=>'input-date','place'=>'请选择保修起始','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">过保时间：</td>
            <td align="left"> <?php echo inputs(array('name'=>'bxedate','place'=>'请选择过保时间','add'=>'input-date','width'=>'20')); ?> </td>
          </tr>
          <tr>
            <td width="120" height="32" align="right" valign="middle">图片：</td>
            <td align="left" colspan="5">
             <?php echo uppic(['tips'=>'请选择设备图片，尺寸保持在400*400即可']); ?>
            </td>
          </tr> 
          <tr>
          ...
          <tr>
            ...
            <td colspan="5"align="left"><?php echo btn(array('vals'=>'确定添加','size'=>3,'type'=>'submit','icon'=>'edit','scene'=>'primary')); ?></td>
          </tr>
        </table>
      </form>
    </div>
