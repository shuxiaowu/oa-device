<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\syslogs.tpl";i:1553045237;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <div class="pubmain">
  ...
  <div class="btn-group">
  <?php echo btn(array('vals'=>'列表模式','size'=>3,'icon'=>'th-list','scene'=>$scene[0],'round'=>1,'url'=>url('system/syslogs','act=1&pm='.$pm))); ?>
  <?php echo btn(array('vals'=>'文件夹模式','size'=>3,'icon'=>'folder-open','scene'=>$scene[1],'url'=>url('system/syslogs','act=2&pm='.$pm))); ?>
  <?php echo btn(array('vals'=>'日志统计','size'=>3,'icon'=>'signal','scene'=>'default','round'=>1,'tips'=>'统计文件夹内上传文件大小，文件夹数量，文件数量','dir'=>'bottom','add'=>'mysignal')); ?>
  </div>
  ...
  <div class="alert alert-primary filesignal" style="display:none; margin:0;">
   ...
   <p>目录大小：<b><?php echo $upTotal['size']; ?></b></p>
   <p>　文件数：<b><?php echo $upTotal['count']; ?> 个</b></p>
   <p>　目录数：<b><?php echo $upTotal['dircount']; ?> 个</b></p>
  </div>
  <?php if($act == 1): ?>
  <form name="publist" method="post" action="<?php echo url('system/sysdellogs'); ?>" onSubmit="return pubdel(document.publist)">
  <?php if($data != ''): ?>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="<?php echo tabstyle(); ?>">
   <tr class="active">
     ...
     <td width="160" align="left" valign="middle"><?php echo icon('time'); ?> 日志时间</td>
   ...
   <tr class="maintr">
    <td align="center" valign="middle" height="25"><?php echo ckbox($obj['file'],$i-1); ?></td>
    <td align="left" valign="middle"><?php echo $obj['file']; ?></td>
    <td align="left" valign="middle"><?php echo $obj['size']; ?></td>
    <td align="left" valign="middle"><?php echo $obj['time']; ?></td>
    <td align="left" valign="middle"><a href="javascript:void(0)" class="open-logs" data-path="<?php echo $obj['file']; ?>"><?php echo btn(array('vals'=>'查看','round'=>1,'icon'=>'eye-open','tips'=>'点击查看日志详情')); ?></a></td>
   </tr>
   <?php endforeach; endif; else: echo "" ;endif; ?>
   <tr>
    <td align="center" valign="middle"><?php echo ckall(); ?></td>
    <td height="35" align="left" valign="middle" colspan="4">
	 <?php echo btn(array('vals'=>'删除','type'=>'submit','icon'=>'trash','round'=>1,'name'=>'deldata','scene'=>'danger')); ?>&nbsp;
     <?php echo $dshow['pageshow']; ?>
    </td>
   </tr>
  </table>
   <input type="hidden" value="<?php echo $pm; ?>" name="type">
   <input type="hidden" value="<?php echo $path; ?>" name="path">
  <?php else: ?>
   <div class="alert alert-primary" style="margin:0 0 10px 0">暂无日志信息</div>
  <?php endif; ?>
  </form>
  <?php endif; if($act == 2): if(is_array($file) || $file instanceof \think\Collection || $file instanceof \think\Paginator): $i = 0; $__LIST__ = $file;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fobj): $mod = ($i % 2 );++$i;if($fobj['count'] == 0): ?>
      <a href="javascript:void(0)">
    <?php else: ?>
      <a href="<?php echo url('system/syslogs','pm='.$pm.'&path='.$fobj['file']); ?>">
    <?php endif; ?>
    <div class="myfolder">
 ...
 <div style="padding:10px; box-sizing:border-box"><div class="alert alert-info"><?php echo icon('warning-sign'); ?> 提示，任何日志删除都无法找回，建议只删除日期比较前的日志！</div></div>
 </div>
 ...
 <script type="text/javascript">
  (function ($) {
    ...
    $(".open-logs").click(function(e) {
	  ...
	  $.post('<?php echo url("system/showlog"); ?>', {'path':path,'pm':pm},function(data){
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="border-radius:0;">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal"><?php echo icon('off'); ?> 关闭</button>
      </div>
    </div>
  </div>
 </div>
