<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\tiaoboadd.tpl";i:1555407278;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
      ...
      <form name="adminform" method="post" action="" onSubmit="return sysassets(document.adminform)">
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="table tablevh">
          <tr>
            ...
            <td width="200" align="left"><?php echo inputs(array('name'=>'','place'=>'请输入调拨管理','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">调拨单号<font class="addred">*</font>：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'','place'=>'请输入调拨单号','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">调入单位<font class="addred">*</font>：</td>
            <td align="left"><?php echo inputs(array('name'=>'recipient','place'=>'请输入调入单位','width'=>'20')); ?></td>
          </tr>
          <tr>
            <td width="120" align="right" valign="middle">调入部门：</td>
            <td align="left"> <?php echo inputs(array('name'=>'lingdate','place'=>'请输入调入部门','width'=>'20')); ?> </td>
            <td width="200" align="right" valign="middle">接收人：</td>
            <td align="left"> <?php echo inputs(array('name'=>'lingdate','place'=>'请输入接收人：','width'=>'20')); ?> </td>
            <td width="120" height="32" align="right" valign="middle">申请时间<font class="addred">*</font>：</td>
            <td align="left"><?php echo inputs(array('name'=>'','add'=>'input-date','place'=>'选择申请时间','width'=>'20')); ?> </td>
          </tr>
          <tr>
         
            <td width="120" align="right" valign="middle">状态：</td>
            <td align="left"><?php echo dropdown([['Id'=>1,'topic'=>'未转移'],['Id'=>2,'topic'=>'已转移']],0,'请选择','state'); ?></td>
          </tr>
          <tr>
          ...
          <td width="120" align="right" valign="middle">是否完成：</td>
            <td align="left"> <?php echo dropdown([['Id'=>1,'topic'=>'未完成'],['Id'=>2,'topic'=>'完成']],0,'请选择','isachieve'); ?></td>
          </tr>
          <tr>
            <td width="120" height="32" align="right" valign="middle">调拨时间<font class="addred">*</font>：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'','add'=>'input-date','place'=>'选择转移时间','width'=>'20')); ?> </td>
          </tr>
          <tr>
