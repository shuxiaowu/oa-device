    ...
    <div class="pubmain" style="min-width:2800px;">
        <div class="panel-body">
            <div class="u-plus btn-group">
                <?php if($userid != 1): ?>
                    <?php echo btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/bxadd'))); endif; ?>
            </div>
            <form name="pubserch" method="get" action="<?php echo url('assets/bxlist'); ?>">
                ...
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
                    <tr class="active">
                        ...
                        <td width="100" align="center" valign="middle">保险期限</td>
                         <td width="100" align="center" valign="middle">保险金额</td>
                          <td width="100" align="center" valign="middle">保险单号码</td>
                        <td width="100" align="center" valign="middle">保险公司名称</td>
                        <td width="100" align="center" valign="middle">有无事故</td>
                        <td width="100" align="center" valign="middle">责任比例</td>
                        <td width="100" align="center" valign="middle">所赔金额</td>
                    ...
                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
                        <tr class="maintr">
                            ...
                            <td align="center" valign="middle"><?php echo showdate($obj['deadlinestart']); ?>-<?php echo showdate($obj['deadlineend']); ?></td>
                            <td align="center" valign="middle"><?php echo $obj['price']; ?></td>
                            <td align="center" valign="middle"><?php echo $obj['bxnum']; ?></td>
                            <td align="center" valign="middle"><?php echo $obj['bxname']; ?></td>
                            <td align="center" valign="middle"><font color="red"><?php echo $obj['isaccident']==0?'--':isaccident($obj['isaccident']); ?></font></td>
                            <td align="center" valign="middle"><?php echo $obj['ratio']; ?></td>
                            <td align="center" valign="middle"><?php echo $obj['payloss']; ?></td>
                            <td align="center" valign="middle"><?php echo $obj['remark']; ?></td>
                            <?php if($userid == 1): ?>
                                <td align="center" valign="middle"><?php echo $obj['adminrealname']; ?></td>
                            <?php endif; ?>
                            <td align="center" valign="middle">
                                <?php echo btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/bxmod','id='.$obj['Id']))); ?>
                            </td>
                        </tr>
