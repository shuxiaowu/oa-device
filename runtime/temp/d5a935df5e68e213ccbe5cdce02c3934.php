<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:81:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\admindepartment.tpl";i:1530777948;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
  ...
  <div class="pubmain">
    <div class="panel-body">
      <div class="u-plus"><?php echo btn(array('vals'=>'添加部门','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>url('system/admindepartmentadd'))); ?></div>
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
          ...
          <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
            <tr class="maintr">
              ...
              <td align="center" valign="middle"><?php $auth = ($obj['auth']!='') ? explode(",",$obj['auth']) : array();echo count($auth).' 个'; ?></td>
              ...
              <td align="left" valign="middle"><?php echo btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('system/admindepartmentmod','id='.$obj['Id']))); ?></td>
            </tr>
          <?php endforeach; endif; else: echo "" ;endif; ?>
          <tr>
            <td height="37" align="center" valign="middle"><?php echo ckall(); ?></td>
            <td height="35" colspan="6" align="left" valign="middle"> <?php echo btn(array('vals'=>'删除','type'=>'submit','name'=>'deldata','round'=>1,'icon'=>'trash','scene'=>'danger')); ?>
              <?php echo $dshow['pageshow']; ?> </td>
          </tr>
        </table>
      </form>
      <div class="alert alert-primary" style="margin:10px auto;"><?php echo icon('warning-sign'); ?> 提示，删除无法恢复，请谨慎操作。</div>
    </div>
  </div>
</div>
</div>
