<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\index\login.tpl";i:1542803534;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
 ...
 <meta name="description" content="<?php echo config('devcompany'); ?>">
 <meta name="keywords" content="<?php echo config('devcompany'); ?>">
...
<style>
body{ font-size:12px;margin:0; padding:0;  background-size:cover; background:url('/oa-device/public/bhadmin/images/fourseasons/<?php echo $bg; ?>') no-repeat center center;background-attachment:fixed;font-family:"微软雅黑"; }
div,input{margin:0; padding:0;-webkit-appearance: none;}
.gear{ width:166px; height:198px; background:url('/oa-device/public/bhadmin/images/gear-line.png') no-repeat center center; position:absolute; z-index:1; left:460px; top:80px; display:none;} 
...
.bhface{ width:120px; height:120px; background:rgba(0,0,0,.6) url('/oa-device/public/bhadmin/images/logo/locklogo.png') no-repeat center center; background-size:80%; border-radius:50%; border:solid 10px #1f292e; float:left; margin-right:20px; cursor:pointer; position:relative;}
...
<body>
<div class="bhmark">背景：<?php echo $scene; ?></div>
<?php if($data['adminpath'] == ''): ?>
 <form name="bhadmin" method="post" action="">
 <div class="i-login">
   <div class="logo"><img src="/oa-device/public/bhadmin/images/logo.png"></div>
 ...
 <div class="gear"><img src="/oa-device/public/bhadmin/images/gear.png" class="gear-div"></div>
 <script type="text/javascript" src="/oa-device/public/bhadmin/js/jquery.min.js"></script>
 <script type="text/javascript">
  function gcode() {
	var files = "<?php echo url('bhadmin/index/logincode','',''); ?>";
  ...
  $(".i-login-btn").click(function(e) {
	...
	$(".i-login-btn").val('登录中....');
    $.post( "<?php echo url('bhadmin/index/checklogin'); ?>", {'user':user,'pass':pass,'code':code},function(data){
	   $(".i-login-btn").val('登录');
	   var loginTips = '';
	   if ( data.state == 1 ) {
	     window.location.href = "<?php echo url('bhadmin/index/index'); ?>";
	   } else {
		 gcode();
 ...
 <?php else: ?>
   <div class="lockscreen">
     ...
     <div class="bhlist">
       <p class="h2"><?php echo config('devcompany'); ?>提醒您！</p>
