<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\syswater.tpl";i:1531798124;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <div class="pubmain">
  ...
  <div class="btn-group">
   <?php echo btn(array('vals'=>'系统设置','size'=>3,'icon'=>'cog','scene'=>'default','round'=>1,'url'=>url('system/sysmod'))); ?>
   <?php echo btn(array('vals'=>'公司设置','size'=>3,'icon'=>'map-marker','scene'=>'default','url'=>url('system/syscompany'))); ?>
   <?php echo btn(array('vals'=>'水印设置','size'=>3,'icon'=>'tint','scene'=>'primary','url'=>url('system/syswater'))); ?>
   <?php echo btn(array('vals'=>'上传设置','size'=>3,'icon'=>'paperclip','scene'=>'default','url'=>url('system/sysupload'))); ?>
   <?php echo btn(array('vals'=>'后台目录设置','size'=>3,'icon'=>'folder-open','scene'=>'default','round'=>1,'url'=>url('system/sysadmin'))); ?>
  ...
  <form name="sysmod" method="post" action="" onSubmit="return sysck(document.sysmod)">
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="<?php echo tabstyle(); ?>">
      ...
      <tr>
        ...
        <td height="42" align="left"><?php echo inputs(array('name'=>'wateralpha','val'=>$data['wateralpha'],'tips'=>'水印透明度，1-100的整数','icon'=>'tint','width'=>'10')); ?></td>
      </tr>
      <tr>
        <td height="42" align="right" valign="middle">水印文字：</td>
        <td height="42" align="left"><?php echo inputs(array('name'=>'fonttext','val'=>$data['fonttext'],'tips'=>'水印文字，建议用字母或文字','units'=>'文','width'=>'20')); ?></td>
      </tr>
      <tr>
        <td height="42" align="right" valign="middle">文字大小：</td>
        <td height="42" align="left"><?php echo inputs(array('name'=>'fontsize','val'=>$data['fontsize'],'tips'=>'水印文字的大小','units'=>'px','width'=>'10')); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="42" align="left">
         <div class="text-warning"><?php echo icon('info-sign'); ?> 从左到右 分别是水印字体A~I的水印样式，字体(B~G)由 THINKPHP 提供，样式生成 字体大小皆为：10px 颜色：#1ea5d7。，<font color="red">新增字体 I（中文字体,苹方）</font></div>
         <div class="waterview">
          <input type="hidden" value="<?php echo $data['facetype']; ?>" name="facetype">
          <div data-id="0" class="waterdemo <?php if($data['facetype'] == 0): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式A'); ?>><img src="/oa-device/public/bhadmin/images/water/A.jpg"></div>
          <div data-id="1" class="waterdemo <?php if($data['facetype'] == 1): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式B'); ?>><img src="/oa-device/public/bhadmin/images/water/B.jpg"></div>
          <div data-id="2" class="waterdemo <?php if($data['facetype'] == 2): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式C'); ?>><img src="/oa-device/public/bhadmin/images/water/C.jpg"></div>
          <div data-id="3" class="waterdemo <?php if($data['facetype'] == 3): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式D'); ?>><img src="/oa-device/public/bhadmin/images/water/D.jpg"></div>
          <div data-id="4" class="waterdemo <?php if($data['facetype'] == 4): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式E'); ?>><img src="/oa-device/public/bhadmin/images/water/E.jpg"></div>
          <div data-id="5" class="waterdemo <?php if($data['facetype'] == 5): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式F'); ?>><img src="/oa-device/public/bhadmin/images/water/F.jpg"></div>
          <div data-id="6" class="waterdemo <?php if($data['facetype'] == 6): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式G'); ?>><img src="/oa-device/public/bhadmin/images/water/G.jpg"></div>
          <div data-id="7" class="waterdemo <?php if($data['facetype'] == 7): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式H'); ?>><img src="/oa-device/public/bhadmin/images/water/H.jpg"></div>
          <div data-id="8" class="waterdemo <?php if($data['facetype'] == 8): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式I'); ?>><img src="/oa-device/public/bhadmin/images/water/I.jpg"></div>
         </div>
        </td>
      </tr>
      <tr>
