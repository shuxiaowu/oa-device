  ...
  <div class="u-main">
    <div class="pubmain" style="min-width:1800px;">
        <div class="panel-body">
            <div class="search">
                <form name="pubserch" method="get" action="<?php echo url('assets/tjyuetailist'); ?>">
                    单位：<?php echo dropdown($droptype,$danwei,gtopic('adminuser',$danwei,'realname'),'danwei','realname'); ?>
                    
                    &nbsp;时间：<?php echo inputs(array('cname'=>'text','name'=>'year','add'=>'input-year','place'=>'年','val'=>$year,'width'=>'5','autocomplete'=>'off')); ?>年
                    <?php echo inputs(array('cname'=>'text','name'=>'month','add'=>'input-month','place'=>'月','width'=>'5','val'=>$month,'autocomplete'=>'off')); ?>月
            ...
            <?php if(is_array($datas) || $datas instanceof \think\Collection || $datas instanceof \think\Paginator): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
                <tr class="active">
                    <td width="100" align="center" valign="middle"><?php echo $obj['licensenum']; ?></td>
                    <td width="100" align="center" valign="middle"><?php echo $obj['distance']['distance']==''?'--':$obj['distance']['distance']; ?></td>
                    <td width="100" align="center" valign="middle"><?php echo $obj['distance']['distance']==''?'--':$obj['distance']['distance']+$obj['alldistance']; ?></td>
                    <td width="100" align="center" valign="middle"><?php echo $obj['gas']['gasvolum']==''?'--':$obj['gas']['gasvolum']; ?></td>
                    <td width="100" align="center" valign="middle"></td>
                    <td width="100" align="center" valign="middle"><?php echo $obj['gas']['price']==''?'--':$obj['gas']['price']; ?></td>
                    <td width="100" align="center" valign="middle"></td>
                    <td width="100" align="center" valign="middle"><?php echo $obj['mtprice']['mtprice']==''?'--':$obj['mtprice']['mtprice']; ?></td>
                    <td width="100" align="center" valign="middle"></td>
                    <td width="100" align="center" valign="middle"></td>
                    <td width="100" align="center" valign="middle"></td>
                    <td width="100" align="center" valign="middle"></td>
