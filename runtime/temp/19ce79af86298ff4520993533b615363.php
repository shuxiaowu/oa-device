<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\syspic.tpl";i:1542676666;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <div class="pubmain">
  ...
  <div class="btn-group">
       <?php echo btn(array('vals'=>'列表模式','size'=>3,'icon'=>'th-list','scene'=>$scene[0],'round'=>1,'url'=>url('system/syspic','act=1'))); ?>
       <?php echo btn(array('vals'=>'图文模式','size'=>3,'icon'=>'th','scene'=>$scene[1],'url'=>url('system/syspic','act=2'))); ?>
       <?php echo btn(array('vals'=>'文件夹模式','size'=>3,'icon'=>'folder-open','scene'=>$scene[2],'url'=>url('system/syspic','act=3'))); ?>
       <?php echo btn(array('vals'=>'图片统计','size'=>3,'icon'=>'signal','scene'=>'default','round'=>1,'tips'=>'统计文件夹内上传文件大小，文件夹数量，文件数量','dir'=>'bottom','add'=>'mysignal')); ?>
  </div>
  <div class="ui-block" style="height:10px;"></div>
  <div class="alert alert-primary filesignal" style="display:none; margin:0">
   <p>统计路径：<b> <?php echo $upTotal['file']; ?></b></p>
   <p>统计大小：<b> <?php echo $upTotal['size']; ?></b></p>
   <p>　文件数：<b> <?php echo $upTotal['count']; ?> 个</b></p>
   <p>　目录数：<b> <?php echo $upTotal['dircount']; ?> 个</b></p>
  </div>
  
  <?php if($act == 1): ?>
  <form name="publist" method="post" action="<?php echo url('system/sysdelpic'); ?>" onSubmit="return pubdel(document.publist)">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablev <?php echo tabstyle(); ?>">
   <tr class="active">
     ...
     <td width="160" align="left" valign="middle">上传时间</td>
     <td width="80" align="left" valign="middle">是否冗余</td>
     <td align="left" valign="middle">查看</td>
   </tr>
   <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;if($obj['isou'] == 1): ?>
   <tr class="maintr">
   <?php else: ?>
   ...
   <?php endif; ?>
    ...
    <?php if($obj['isou'] == 1): ?>
     <?php echo ckbox($obj['pic'],$i-1,0,1); else: ?>
    ...
    <td align="left" valign="middle">
     <div class="zomm-pic"><img src="<?php echo root(); ?>/<?php echo $obj['pic']; ?>" data-action="zoom"></div>
    </td>
   </tr>
   ...
   <tr>
    ...
    <td height="35" align="left" valign="middle" colspan="5">
	 <?php echo btn(array('vals'=>'删除','type'=>'submit','icon'=>'trash','name'=>'deldata','round'=>1,'scene'=>'danger')); ?>&nbsp;
     <font>冗余的图片默认勾选</font>
  ...
  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
      <div class="syspicshow">
       <div class="sysmypic"><img src="<?php echo root(); ?>/<?php echo $obj['pic']; ?>" data-action="zoom"></div>
       <div class="sysmypic-foot">
	     <?php if($obj['isou'] == 1): ?>
          <font color="green">正常</font>  <?php echo ckbox($obj['pic'],$i-1,0,1); else: ?>
  ...
  <div class="delmostdiv" style="margin:5px auto 0px 0px; clear:both;">
   <?php echo ckall(2).'&nbsp;选择(默认选择冗余图片)&nbsp;'.btn(array('vals'=>'删除','type'=>'submit','size'=>4,'round'=>1,'icon'=>'trash','name'=>'deldata','scene'=>'danger')); ?>
   <?php echo $dshow['pageshow']; ?>
  </div>
  </form>
  <?php endif; if($act == 3): if(is_array($file) || $file instanceof \think\Collection || $file instanceof \think\Paginator): $i = 0; $__LIST__ = $file;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fobj): $mod = ($i % 2 );++$i;if($fobj['count'] == 0): ?>
    <a href="javascript:void(0)">
    <?php else: ?>
    <a href="<?php echo url('system/syspic','act=4&path='.$fobj['file']); ?>">
    <?php endif; ?>
    <div class="myfolder">
 ...
 <div style="padding:10px; box-sizing:border-box"><div class="alert alert-info"><?php echo icon('warning-sign'); ?> 提示，任何图片删除都无法找回，建议只删除冗余的图片！</div></div>
 </div>
</div>
</div>
