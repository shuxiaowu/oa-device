<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\phpStudy\PHPTutorial\WWW\car-oa/app/bhadmin\view\index\login.tpl";i:1557295745;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<style>
body{ font-size:12px;margin:0; padding:0;  background-size:cover; background:url('/car-oa/public/bhadmin/images/fourseasons/<?php echo $bg; ?>') no-repeat center center;background-attachment:fixed;font-family:"微软雅黑"; }
div,input{margin:0; padding:0;-webkit-appearance: none;}
.gear{ width:166px; height:198px; background:url('/car-oa/public/bhadmin/images/gear-line.png') no-repeat center center; position:absolute; z-index:1; left:460px; top:80px; display:none;} 
...
.bhface{ width:120px; height:120px; background:rgba(0,0,0,.6) url('/car-oa/public/bhadmin/images/logo/locklogo.png') no-repeat center center; background-size:80%; border-radius:50%; border:solid 10px #1f292e; float:left; margin-right:20px; cursor:pointer; position:relative;}
...
<?php if($data['adminpath'] == ''): ?>
 ...
 <div class="i-login">
   <div class="logo"><img src="/car-oa/public/bhadmin/images/logo.png" width="100%"></div>
 ...
 <div class="gear"><img src="/car-oa/public/bhadmin/images/gear.png" class="gear-div"></div>
 <script type="text/javascript" src="/car-oa/public/bhadmin/js/jquery.min.js"></script>
