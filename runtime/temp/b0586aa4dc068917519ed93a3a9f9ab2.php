<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\sysapi.tpl";i:1531108732;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <div class="panel-body">
  <div class="u-plus"><?php echo btn(array('vals'=>'添加TOKEN','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>url('system/apiadd'))); ?></div>
  ...
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
   ...
   <tr class="maintr">
    ...
    <td align="center" valign="middle"><?php echo $obj['type']; ?></td>
    <td align="center" valign="middle"><?php echo $obj['appid']; ?></td>
    <td align="center" valign="middle"><a href="javascript:void(0)" class="showsecret" data-secret="<?php echo $secret; ?>"<?php echo tooltip('点击查看完整secret'); ?>><?php echo $mdsecret; ?></a></td>
    <td align="left" valign="middle"><?php echo !empty($obj['remark'])?$obj['remark']:'--'; ?></td>
    <td align="center" valign="middle"><?php echo modattr($obj['Id'],$obj['enabled'],$dshow['table']); ?></td>
    <td align="center" valign="middle"><?php echo !empty($obj['date'])?$obj['date']:'未登录'; ?></td>
    <td align="left" valign="middle"></td>
   </tr>
   ...
   <tr>
    ...
    <?php echo btn(array('vals'=>'删除','type'=>'submit','name'=>'deldata','round'=>1,'icon'=>'trash','scene'=>'danger')); ?>
    <?php echo $dshow['pageshow']; ?>
    </td>
   </tr>
   </table>
   </form>
   <div class="alert alert-info" style="margin:10px auto"><?php echo icon('warning-sign'); ?> 提示，任何形式删除的数据都无法找回。</div>
 </div>
