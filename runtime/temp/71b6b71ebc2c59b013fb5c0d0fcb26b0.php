<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\apirecord.tpl";i:1530922032;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
    ...
    <div class="panel-body">
      <form name="pubserch" method="get" action="">
        <div class="search"> 接口名称：
          ...
          &nbsp;身份：
          <input type="text" class="text" name="apitype" value="<?php echo $apitype; ?>" placeholder="身份" style="width:80px;">
          &nbsp;请求时间：
          <input type="text" value="<?php echo $sday; ?>" name="sday" class="textsort input-date">
          至&nbsp;
          <input type="text" value="<?php echo $eday; ?>" name="eday" class="textsort input-date">
          &nbsp;<?php echo btn(array('vals'=>'查询','type'=>'submit','icon'=>'search','name'=>'searchdata','round'=>1,'scene'=>'primary')); ?> </div>
      </form>
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
          ...
          <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
            <tr class="maintr">
              ...
              <td><?php echo $obj['apitype']; ?></td>
              <td align="center"><?php echo date('Y-m-d H:i:s',$obj['date']); ?></td>
              <td align="center"><button class="btn btn-xs btn-success btn-show" type="button" data-id="<?php echo $obj['Id']; ?>"><span class="glyphicon glyphicon-eye-open"></span> 查看</button>
                <?php echo btn(['vals'=>'模拟','faicon'=>'github-alt','url'=>url('bhadmin/system/tool','id='.$obj['Id'])]); ?> </td>
            </tr>
          <?php endforeach; endif; else: echo "" ;endif; ?>
          <tr>
            <td height="37" align="center" valign="middle"><?php echo ckall(2); ?></td>
            <td height="35" colspan="8" align="left" valign="middle"> <?php echo btn(array('vals'=>'删除','type'=>'submit','name'=>'deldata','round'=>1,'icon'=>'trash','scene'=>'danger')); ?> <font class="text-warning">&nbsp;<?php echo icon('warning-sign'); ?> 提示，任何形式删除的数据都无法找回，请谨慎操作！</font> <?php echo $dshow['pageshow']; ?> </td>
          </tr>
        </table>
      </form>
    </div>
  ...
  $(document).ready(function(e) {
    $(".btn-show").click(function(e) {
	 ...
	 var id    = $(this).data('id');
	 if ( id ) {
	   $.post('<?php echo url("system/ajaxrecord"); ?>',{'id':id},function(data){
		 $("#showdata").modal('show');
	     $btn.button('reset')  
	     if ( data.state == 1 ) {
