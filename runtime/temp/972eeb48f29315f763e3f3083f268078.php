<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\chukumod.tpl";i:1555381674;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
  ...
  <div class="pubmain">
    <div class="panel-body">
      ...
      <tr>
            ...
            <td width="200" align="left"><?php echo inputs(array('name'=>'danhao','val'=>$data['danhao'],'place'=>'请输入领用单号','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">领用部门<font class="addred">*</font>：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'branch','val'=>$data['branch'],'place'=>'请输入领用部门','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">领用人<font class="addred">*</font>：</td>
            <td align="left"><?php echo inputs(array('name'=>'recipient','val'=>$data['recipient'],'place'=>'请输入领用人','width'=>'20')); ?></td>
          </tr>
          <tr>
            <td width="120" height="32" align="right" valign="middle">申请时间<font class="addred">*</font>：</td>
            <td width="200" align="left"><?php echo inputs(array('name'=>'applydate','val'=>$data['applydate'],'add'=>'input-date','place'=>'选择申请时间','width'=>'20')); ?> </td>
            <td width="120" align="right" valign="middle">领用状态：</td>
            <td width="200" align="left"><?php echo dropdown([['Id'=>1,'topic'=>'未领用'],['Id'=>2,'topic'=>'领用']],$data['state'],'请选择','state'); ?></td>
            <td width="120" align="right" valign="middle">领用时间：</td>
            <td align="left"> <?php echo inputs(array('name'=>'lingdate','val'=>$data['lingdate'],'add'=>'input-date','place'=>'选择领用时间','width'=>'20')); ?> </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="left" colspan="5">
            <textarea class="mytextarea form-control" name="guihuan" style="width:880px !important;"><?php echo $data['guihuan']; ?></textarea>
            </td>
          </tr> 
          <tr>
