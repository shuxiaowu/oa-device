...
<div class="u-container">
  ...
  <div class="u-main">
    <script src="/car-oa/public/bhadmin/js/highcharts.js"></script>
    <style>
    .panel-body {
        min-height: 300px;
    }
    ...
    <div class="pubmain">
        <div class="panel-body">
            <div class="chart-group" style="margin-bottom:10px;">
                <div class="chart-div" onClick="window.location='<?php echo url(" licai/tzlist"); ?>'"> <div class="chart-icon"><?php echo faicon('clipboard'); ?></div>
                <div class="chart-topic">
                    <b></b>
                    <span title=""></span>
                </div>
            </div>
            <div class="chart-div sence2" onClick="window.location='<?php echo url(" licai/jklist"); ?>'"> <div class="chart-icon"><?php echo faicon('clipboard'); ?></div>
            <div class="chart-topic">
                <b></b>
                <span title=""></span>
            </div>
        </div>
        <div class="chart-div sence3" onClick="window.location='<?php echo url(" licai/tzcheck"); ?>'"> <div class="chart-icon"><?php echo faicon('pencil'); ?></div>
        <div class="chart-topic">
            <b></b>
            <span></span>
        </div>
    </div>
    <div class="chart-div sence5" onClick="window.location='<?php echo url(" licai/jkcheck"); ?>'"> <div class="chart-icon"><?php echo faicon('pencil'); ?></div>
    <div class="chart-topic">
        <b></b>
        <span></span>
    </div>
    </div>
    <div class="chart-div sence4" onClick="window.location='<?php echo url(" user/userlist"); ?>'"> <div class="chart-icon"><?php echo picon('male-female'); ?></div>
    <div class="chart-topic">
        <b></b>
        <span></span>
    </div>
