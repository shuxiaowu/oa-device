<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\sysmsg.tpl";i:1542628654;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <div class="pubmain">
  ...
  <div class="btn-group">
   ...
   <?php echo btn(array('vals'=>'短信设置','size'=>3,'faicon'=>'commenting','scene'=>'primary','url'=>url('system/sysmsg'))); ?>
   <?php echo btn(array('vals'=>'微信设置','size'=>3,'faicon'=>'weixin','scene'=>'default','url'=>url('system/sysweixin'))); ?>
  </div>
   <div class="alert alert-primary" style="margin:10px auto 10px auto">账户检测：<span><?php echo $msgtips; ?></span>，登录<a href="http://web.jianzhou.sh.cn:8080/WebSMP/" target="_blank" style="color:#f00;">建周短信平台</a>查看详细短信信息！</div>
   ...
   <form name="sysmod" method="post" action="">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="<?php echo tabstyle(); ?>">
      ...
      <tr>
        ...
        <td height="25" align="left" valign="middle"><?php echo inputs(array('icon'=>'user','width'=>25,'place'=>'您的账号','name'=>'msguser','val'=>$data['msguser'],'tips'=>'输入短信账号')); ?></td>
      </tr>
      <tr>
        <td height="25" align="left" valign="middle">账号密码</td>
        <td height="25" align="left" valign="middle"><?php echo inputs(array('faicon'=>'unlock','type'=>'password','width'=>25,'place'=>'账号密码','name'=>'msgpass','val'=>$data['msgpass'],'tips'=>'输入短信密码')); ?></td>
      </tr>
      <tr>
        <td height="25" align="left" valign="middle">短信尾巴<br/>说明：出现在短信尾部<br/>例如：百恒网络</td>
        <td height="25" align="left" valign="middle"><?php echo inputs(array('faicon'=>'commenting','width'=>25,'place'=>'短信尾巴','name'=>'msgsuff','val'=>$data['msgsuff'],'tips'=>'输入短信尾巴，出现在短信尾部')); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="35" align="left" valign="middle"><?php echo btn(array('vals'=>'确定保存','size'=>3,'type'=>'submit','icon'=>'cog','scene'=>'primary')); ?></td>
      </tr>
    </table>
   </form>
  </div>
 ...
 <script type="text/javascript">
  $(".sendphone").click(function(e) {
	...
	if(phone==''){
	  ...
	  $.post( "<?php echo url('admin/phonetest'); ?>", {'phone':phone},function(data){
  ...
  $(document).ready(function(e) {
     $.post('<?php echo url("bhadmin/system/getmsgcount"); ?>',{},function(data){
