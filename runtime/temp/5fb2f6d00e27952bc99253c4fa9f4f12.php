<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\pdresult.tpl";i:1554802684;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
    ...
    <div class="panel-body">
        <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
          ...
          <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
            <tr class="maintr">
              <td align="center" valign="middle" height="37"><?php echo $dshow['pageno']+$i; ?></td>
              <td align="center" valign="middle"><?php echo $obj['pdsn']; ?></td>
              <td align="left" valign="middle"><?php echo $obj['devno']; ?></td>
              <td align="left" valign="middle"><?php echo date('Y-m-d H:i:s',$obj['pdtime']); ?></td>
            </tr>
