...
<div class="u-container">
  ...
  <div class="pubmain">
    <div class="panel-body">
      <div class="u-plus"><?php echo btn(array('vals'=>'添加管理员','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>url('system/useradd'))); ?></div>
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
          ...
          <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
            <tr class="maintr">
              ...
              <td align="left" valign="middle"><?php echo $obj['user']; ?></td>
              <td align="left" valign="middle"><?php echo $obj['realname']; ?></td>
              <td align="left" valign="middle"><?php echo gtopic('admindepartment',$obj['depid'],'topic','--'); ?></td>
              <td align="center" valign="middle"><?php echo $obj['count']; ?></td>
              <td align="center" valign="middle"><?php echo !empty($obj['last_ip'])?$obj['last_ip']:'未登录'; ?></td>
              <td align="center" valign="middle"><?php echo !empty($obj['last_time'])?$obj['last_time']:'未登录'; ?></td>
              <td align="left" valign="middle"><?php echo btn(array('vals'=>'编辑','round'=>1,'icon'=>'edit','tips'=>'点击编辑数据','url'=>url('system/usermod','id='.$obj['Id']))); ?></td>
            </tr>
          <?php endforeach; endif; else: echo "" ;endif; ?>
          <tr>
            <td height="37" align="center" valign="middle"><?php echo ckall(2); ?></td>
            <td height="35" colspan="7" align="left" valign="middle"> <?php echo btn(array('vals'=>'删除','type'=>'submit','name'=>'deldata','round'=>1,'icon'=>'trash','scene'=>'danger')); ?>
              <?php echo $dshow['pageshow']; ?> </td>
          </tr>
        </table>
      </form>
      <div class="alert alert-primary" style="margin:10px auto;"><?php echo icon('warning-sign'); ?> 提示，任何形式删除的数据都无法找回，管理员删除，请保证后台至少有一个管理用户。</div>
    </div>
  </div>
</div>
</div>
