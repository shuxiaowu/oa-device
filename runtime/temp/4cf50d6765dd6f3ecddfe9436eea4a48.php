    ...
    <div class="pubmain">
        <div class="panel-body">
            <div class="u-plus btn-group">
                <?php if($userid != 1): ?>
                    <?php echo btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/gasrecordadd'))); endif; ?>
            </div>
            <form name="pubserch" method="get" action="<?php echo url('assets/gasrecordlist'); ?>">
                ...
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
                    ...
                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
                        <tr class="maintr">
                            ...
                            <td align="center" valign="middle"><?php echo $obj['gastype']; ?></td>
                            <td align="center" valign="middle"><?php echo $obj['gasvolum']; ?></td>
                            <td align="center" valign="middle"><?php echo showdate($obj['adddate']); ?></td>
                            ...
                            <td align="center" valign="middle">
                                <?php echo btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/gasrecordmod','id='.$obj['Id']))); ?>
                            </td>
                        </tr>
