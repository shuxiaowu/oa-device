<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\sysaddress.tpl";i:1545869488;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <form name="pubserch" method="get" action=""> 
  <div class="search" style="margin-bottom:10px;">
   地址名称：<input type="text" class="text" name="name" value="<?php echo $name; ?>" placeholder="地址名称" style="width:150px;">
 ...
 <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)"> 
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
   ...
   <tr class="maintr">
    <td align="center" valign="middle"><?php echo $dshow['pageno']+$i; ?></td>
    <td align="center" valign="middle"><?php echo $obj['Id']; ?></td>
    <td align="left" valign="middle"><?php echo modField($obj['name'],$obj['Id'],'name',$dshow['table']); ?></td>
    <td align="center" valign="middle"><?php echo gaddress($obj['upid'],'--'); ?></td>
    <td align="center" valign="middle">
    <?php if($obj['level'] == 1): ?>省/行政区<?php endif; if($obj['level'] == 2): ?>市<?php endif; if($obj['level'] == 3): ?>区<?php endif; if($obj['level'] == 4): ?>街道<?php endif; ?>
    </td>
    <td align="center" valign="middle"><?php echo modattr($obj['Id'],$obj['ishot'],$dshow['table'],'ishot',array('热门','取消')); ?></td>
    <td align="center" valign="middle"><?php echo modattr($obj['Id'],$obj['enabled'],$dshow['table']); ?></td>
    <td align="left" valign="middle">
     <?php if($obj['level'] != 4): ?>
      	<?php echo btn(array('vals'=>'添加','scene'=>'danger','tips'=>'添加数据到'.$obj['name'].'旗下','round'=>1,'url'=>url('system/addressadd','did='.$obj['Id'].'&lev='.((int)$obj['level']+1)))).'&nbsp;'; ?> 
	    <?php echo btn(array('vals'=>'查看','icon'=>'eye-open','scene'=>'success','tips'=>'点击查看旗下数据','round'=>1,'url'=>url('system/sysaddress','lev='.((int)$obj['level']+1).'&did='.$obj['Id']))).'&nbsp;'; else: ?>
     	<?php echo btn(array('vals'=>'添加','scene'=>'danger','round'=>1,'ban'=>1)).'&nbsp;'; ?>
	    <?php echo btn(array('vals'=>'查看','icon'=>'eye-open','scene'=>'success','round'=>1,'ban'=>1)).'&nbsp;'; endif; ?>
     <?php echo btn(array('vals'=>'编辑','icon'=>'edit','tips'=>'点击编辑数据','round'=>1,'url'=>url('system/addressmod','id='.$obj['Id']))); ?>
    </td>
   </tr>
   <?php endforeach; endif; else: echo "" ;endif; if($dshow['pageshow'] != ''): ?>
   <tr>
