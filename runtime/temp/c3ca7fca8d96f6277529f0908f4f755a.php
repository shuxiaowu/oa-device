<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\index\modpass.tpl";i:1530875894;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <form name="adminform" method="post" action="" class="panel-body form-horizontal form-padding padding-null" onSubmit="return modpass(document.adminform)" style="margin-top:20px;">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
           <?php echo inputs(array('name'=>'user','val'=>$adminauth['adminuser'],'disabled'=>1,'width'=>18)); ?>
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-2 control-label" for="demo-text-input">登录密码：</label>
        <div class="col-md-10">
           <?php echo inputs(array('type'=>'password','name'=>'pass','place'=>'请输入您当前的登录密码','width'=>30)); ?>
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-2 control-label" for="demo-text-input">新密码：</label>
        <div class="col-md-10">
            <?php echo inputs(array('type'=>'password','name'=>'newpass','place'=>'请输入您的新密码','width'=>30)); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
          <?php echo inputs(array('type'=>'password','name'=>'notpass','place'=>'请输入确认新密码','width'=>30)); ?>
        </div>
    </div>
        <div class="row">
           <div class="col-md-2"></div> <div class="col-md-10"><?php echo btn(array('vals'=>'修改密码','size'=>3,'type'=>'submit','scene'=>'primary')); ?></div>
        </div>	            
 </form>
 </div>
