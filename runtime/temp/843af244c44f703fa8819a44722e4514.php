    ...
    <div class="pubmain" style="min-width:1200px;">
        <div class="panel-body">
            <div class="u-plus btn-group">
                <?php echo btn(array('vals'=>'新建转移单','size'=>3,'scene'=>'primary','url'=>url('assets/zhejiuadd'))); ?>
            </div>
            <form name="pubserch" method="get" action="<?php echo url('assets/movelist'); ?>">
            ...
            <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)">
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
                    <tr class="active">
                        ...
                        <td width="100" align="center" valign="middle">资产原值</td>
                        <td width="100" align="center" valign="middle">预计净残值</td>
                        <td width="100" align="center" valign="middle">使用年限</td>
                        <td width="100" align="center" valign="middle">残值率</td>
                        <td width="100" align="center" valign="middle">已使用月份</td>
                        <td width="100" align="center" valign="middle">月折旧额</td>
                        <td width="100" align="center" valign="middle">年折旧额</td>
                        <td width="100" align="center" valign="middle">累计折旧</td>
                        <td width="100" align="center" valign="middle">净值</td>
                        <td width="100" align="center" valign="middle">截止计算日期</td>
                        <!-- <td width="140" align="center" valign="middle">操作</td> -->
                    </tr>
                    <tr class="maintr">
                        <td align="center" valign="middle" height="37"><?php echo ckbox(1,$i-1); ?></td>
                        <td align="center" valign="middle">2415454512</td>
                        <td align="center" valign="middle">资产名称</td>
                        <td align="center" valign="middle">资产原值</td>
                        <td align="center" valign="middle">预计净残值</td>
                        <td align="center" valign="middle">5年</td>
                        <td align="center" valign="middle">24%</td>
                        <td align="center" valign="middle">12</td>
                        <td align="center" valign="middle">5454</td>
                        <td align="center" valign="middle">6565</td>
                        <td align="center" valign="middle">500km</td>
                        <td align="center" valign="middle">净值</td>
