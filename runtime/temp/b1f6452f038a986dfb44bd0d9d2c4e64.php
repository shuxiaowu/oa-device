    ...
    <div class="pubmain">
        <div class="panel-body">
            <div class="u-plus btn-group">
                <?php if($userid != 1): ?>
                    <?php echo btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/maintainadd'))); endif; ?>
            </div>
            <form name="pubserch" method="get" action="<?php echo url('assets/maintainlist'); ?>">
            ...
            <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)">
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
                    <tr class="active">
                        <td align="center" valign="middle" height="37"><?php echo ckall(); ?></td>
                        ...
                        <td align="center" valign="middle">记录员</td>
                        <td align="center" valign="middle">维修日期</td>
                        <td align="center" valign="middle">维修项目</td>
                        <td align="center" valign="middle">维修费用(元)</td>
                         <?php if($userid == 1): ?>
                    ...
                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
                        <tr class="maintr">
                            ...
                            <td align="center" valign="middle"><?php echo $obj['recorder']; ?></td>
                            <td align="center" valign="middle"><?php echo showdate($obj['mtdate']); ?></td>
                            <td align="center" valign="middle"><?php echo $obj['mtproject']; ?></td>
                            <td align="center" valign="middle"><?php echo $obj['mtprice']; ?></td>
                            <?php if($userid == 1): ?>
                             <td align="center" valign="middle"><?php echo $obj['adminrealname']; ?></td>
                             <?php endif; ?>
                            <td align="center" valign="middle">
                                <?php echo btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/maintainmod','id='.$obj['Id']))); ?>
                            </td>
                        </tr>
