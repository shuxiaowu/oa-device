<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\equiplist.tpl";i:1555460426;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
  ...
  <div class="pubmain" style="min-width:1200px;">
    <div class="panel-body">
      <div class="u-plus btn-group">
        <?php echo btn(array('vals'=>'新建转移单','size'=>3,'scene'=>'primary','url'=>url('assets/equipadd'))); ?>
      ...
      <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)">
        <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
          <tr class="active">
            ...
            <td width="100" align="center" valign="middle">设备编号</td>
            <td width="100" align="center" valign="middle">设备名称</td>
            <td width="100" align="center" valign="middle">型号</td>
            <td width="100" align="center" valign="middle">管理部门</td>
            <td width="100" align="center" valign="middle">管理员</td>
            <td width="100" align="center" valign="middle">状态</td>
            <td width="100" align="center" valign="middle">单位</td>
            <td width="100" align="center" valign="middle">单价</td>
            <td width="100" align="center" valign="middle">入账日期</td>
           ...
           <tr class="maintr">
             ...
             <td align="center" valign="middle">设备名称一</td>
             <td align="center" valign="middle">型号一</td>
             <td align="center" valign="middle">管理部门</td>
             <td align="center" valign="middle">管理员一</td>
             <td align="center" valign="middle">闲置</td>
             <td align="center" valign="middle">单位</td>
