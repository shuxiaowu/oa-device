...
<div class="u-container">
  ...
  <div class="u-main">
    <div class="pubmain" style="min-width:1000px;">
        <div class="panel-body">
            <div class="u-plus btn-group">
                <?php if($userid != 1): ?>
                    <?php echo btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/sealadd'))); endif; ?>
            </div>
            <form name="pubserch" method="get" action="<?php echo url('assets/seallist'); ?>">
                <div class="search">
            ...
            <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)">
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
                    <tr class="active">
                        ...
                        <td width="100" align="center" valign="middle">封存事由</td>
                        <td width="100" align="center" valign="middle">日期</td>
                        <td width="100" align="center" valign="middle">封存期限</td>
                        <td width="100" align="center" valign="middle">经办人</td>
                        <td width="100" align="center" valign="middle">封存图片</td>
                        <?php if($userid == 1): ?>
                    ...
                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
                        <tr class="maintr">
                            ...
                            <td align="center" valign="middle"><?php echo $obj['fcreson']; ?></td>
                            <td align="center" valign="middle"><?php echo showdate($obj['addtime']); ?></td>
                            <td align="center" valign="middle"><?php echo showdate($obj['fcdatestart']); ?>至<?php echo showdate($obj['fcdateend']); ?></td>
                            <td align="center" valign="middle"><?php echo $obj['agent']; ?></td>
                            <td align="center" valign="middle"><img src="<?php echo upic($obj['fcpic']); ?>" height="30px"></td>
                            <?php if($userid == 1): ?>
                                <td align="center" valign="middle"><?php echo $obj['adminrealname']; ?></td>
                            <?php endif; ?>
                            <td align="center" valign="middle">
                                <?php echo btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/sealmod','id='.$obj['Id']))); ?>
                            </td>
                        </tr>
