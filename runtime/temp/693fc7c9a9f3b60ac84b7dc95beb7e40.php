<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\msghistory.tpl";i:1530710894;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <form name="pubserch" method="get" action="" style="margin-bottom:10px;"> 
  <div class="search">
   ...
   &nbsp;发送成功：<?php echo dropdown([['Id'=>1,'topic'=>'成功'],['Id'=>2,'topic'=>'失败']],0,'请选择','issuccess'); ?>
   &nbsp;类目：<?php echo dropdown([['Id'=>1,'topic'=>'手机发送'],['Id'=>2,'topic'=>'邮箱发送'],['Id'=>3,'topic'=>'微信发送'],['Id'=>4,'topic'=>'极光推送'],['Id'=>5,'topic'=>'模板消息']],0,'请选择','type'); ?>
   &nbsp;发送时间：<input type="text" value="<?php echo $sday; ?>" name="sday" class="textsort input-date">
   至&nbsp;<input type="text" value="<?php echo $eday; ?>" name="eday" class="textsort input-date">
  ...
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
   ...
   <tr class="maintr">
    ...
    <td align="left" valign="middle"><?php echo !empty($obj['amount'])?$obj['amount']:'--'; ?></td>
    <td align="left" valign="middle"><?php echo !empty($obj['sysuser'])?$obj['sysuser']:'--'; ?></td>
    <td align="center" valign="middle">
     <?php if($obj['type'] == 1): ?>手机<?php endif; if($obj['type'] == 2): ?>邮箱<?php endif; if($obj['type'] == 3): ?>微信<?php endif; if($obj['type'] == 4): ?>极光推送<?php endif; if($obj['type'] == 5): ?>模板消息<?php endif; if($obj['type'] == 6): ?>eqmtt<?php endif; ?>
    </td>
    <td align="center" valign="middle">
     <?php if($obj['successid'] == 1): ?><font color="green">成功</font><?php endif; if($obj['successid'] != 1): ?><font color="red"<?php echo tooltip($obj['successid']); ?>>失败</font><?php endif; ?>
    </td>
    <td align="center" valign="middle"><?php echo date('Y-m-d H:i:s',$obj['date']); ?></td>
    <td align="left" valign="middle"><div style="height:22px; line-height:22px; overflow:hidden; cursor:pointer;" <?php echo tooltip(strip_tags($obj['msg'])); ?>><?php echo strip_tags($obj['msg'])?:'--'; ?></div></td>
   </tr>
   <?php endforeach; endif; else: echo "" ;endif; ?>
   <tr>
    <td height="35" colspan="7" align="left" valign="middle">
    <font class="text-warning">&nbsp;<?php echo icon('warning-sign'); ?> 发送记录暂时不支持删除 ！</font>
