<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\sysweixin.tpl";i:1537434884;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <div class="pubmain">
  ...
  <div class="btn-group">
   ...
   <?php echo btn(array('vals'=>'微信设置','size'=>3,'faicon'=>'weixin','scene'=>'primary','url'=>url('system/sysweixin'))); ?>
  </div>
   ...
   <form name="sysmod" method="post" action="" onSubmit="return ckWeixin(document.sysweixinset)">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="<?php echo tabstyle(); ?>">
      ...
      <tr>
        ...
        <td height="25" align="left" valign="middle"><?php echo inputs(array('faicon'=>'weixin','width'=>30,'place'=>'微信公众号名称','name'=>'wxname','val'=>$data['wxname'],'tips'=>'输入微信公众号名称')); ?></td>
      </tr>     
      <tr>
        <td height="25" align="left" valign="middle">微信APPID</td>
        <td height="25" align="left" valign="middle"><?php echo inputs(array('faicon'=>'weixin','width'=>30,'place'=>'微信APPID','name'=>'wxappid','val'=>$data['wxappid'],'tips'=>'输入微信APPID，登录您的微信公众号获取')); ?></td>
      </tr>
      <tr>
        <td height="25" align="left" valign="middle">微信SECRET</td>
        <td height="25" align="left" valign="middle"><?php echo inputs(array('faicon'=>'weixin','width'=>30,'place'=>'微信SECRET','name'=>'wxsecret','val'=>$data['wxsecret'],'tips'=>'输入微信SECRET，登录您的微信公众号获取')); ?></td>
      </tr>
      <tr>
        <td height="25" align="left" valign="middle">项目URL</td>
        <td height="25" align="left" valign="middle"><?php echo inputs(array('faicon'=>'link','width'=>30,'place'=>'项目URL，需要填写http://','name'=>'companyurl','val'=>$data['companyurl'],'tips'=>'输入项目域名，也是你在公众号填写的授权域名，最后请不要加/结尾，需要填写http://或者https://')); ?> </td>
      </tr>
      <tr>
 ...
 <script type="text/javascript">
   ...
   $('.testwx').click(function(e) {
	  ...
	  $.post( "<?php echo url('bhadmin/admin/weixintest'); ?>", {},function(data){
