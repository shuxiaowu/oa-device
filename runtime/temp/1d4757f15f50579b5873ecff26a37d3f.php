<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\movelist.tpl";i:1555409402;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
    ...
    <div class="pubmain" style="min-width:1200px;">
        <div class="panel-body">
            <div class="u-plus btn-group">
                <?php echo btn(array('vals'=>'新建转移单','size'=>3,'scene'=>'primary','url'=>url('assets/moveadd'))); ?>
            </div>
            <form name="pubserch" method="get" action="<?php echo url('assets/movelist'); ?>">
                <div class="search"> 转移单号/资产编码/名称：
            ...
            <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)">
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
                    <tr class="active">
                        ...
                        <td width="100" align="center" valign="middle">转移单号</td>
                        <td width="100" align="center" valign="middle">转入部门</td>
                        <td width="100" align="center" valign="middle">接收人</td>
                        <td width="100" align="center" valign="middle">存放地方</td>
                        ...
                        <td width="100" align="center" valign="middle">转移时间</td>
                        <!-- <td width="140" align="center" valign="middle">操作</td> -->
                    </tr>
                    <tr class="maintr">
                        <td align="center" valign="middle" height="37"><?php echo ckbox(1,$i-1); ?></td>
                        <td align="center" valign="middle">421423412</td>
                        <td align="center" valign="middle">转入部门</td>
                        <td align="center" valign="middle">接收人</td>
                        <td align="center" valign="middle">存放地方</td>
