<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:71:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\assets\pdmod.tpl";i:1554797894;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
      ...
      <form name="adminform" method="post" action="" onSubmit="return sysabout(document.adminform)">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
          <tr>
            ...
            <td height="32" align="left"><?php echo inputs(array('name'=>'topic','val'=>$data['topic'],'place'=>'盘点任务名称（*必填）')); ?></td>
          </tr>
          <tr>
            <td width="10%" height="32" align="right" valign="middle">盘点人：</td>
            <td height="32" align="left"><?php echo searchField(['tables'=>'adminuser','field'=>'realname','val'=>$data['adminuid'],'s_field'=>'realname','name'=>'adminuid','width'=>200,'default'=>getdata('adminuser',$data['adminuid'],'realname')]); ?></td>
          </tr>          
          <tr>
            <td width="10%" height="32" align="right" valign="middle">盘点开始时间：</td>
            <td height="32" align="left">
              <?php echo inputs(array('name'=>'sdate','add'=>'input-date','val'=>$data['sdate'],'place'=>'盘点开始时间','width'=>'20')); ?> <?php echo inputs(array('name'=>'edate','val'=>$data['edate'],'add'=>'input-date','place'=>'盘点结束时间','width'=>'20')); ?>
            </td>
          </tr> 
          <tr>
            <td height="32" align="right" valign="middle">盘点备注：</td>
            <td height="32" align="left"><?php echo inputs(array('name'=>'remark','type'=>'textarea','val'=>$data['remark'],'place'=>'盘点备注')); ?></td>
          </tr>
