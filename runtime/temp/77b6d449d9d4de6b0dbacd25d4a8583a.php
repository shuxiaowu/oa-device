<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\databackup.tpl";i:1530711140;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <div class="alert alert-primary" style="margin:0px auto 10px auto">数据大小：<?php echo $sdata[0]['data_size']; ?> 索引大小：<?php echo $sdata[0]['index_size']; ?> 数据库占用大小：<?php echo $sdata[0]['data_size']+$sdata[0]['index_size']; ?> MB</span></div>
 <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)"> 
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
   ...
   <tr class="maintr">
    <td align="center" valign="middle" height="35"><input type="checkbox" value="<?php echo $obj['table']; ?>" id="box<?php echo $i; ?>" name="datebasename[]" class="myselect m-checkbox" /><label for="box<?php echo $i; ?>"></label></td>
    ...
    <td align="left" valign="middle">
     &nbsp;<a href="javascript:void(0)" onClick="setData('<?php echo $obj['table']; ?>','opt')"><?php echo btn(array('vals'=>'优化','round'=>1,'tips'=>'优化数据表结构，清除索引数据','faicon'=>'repeat','scene'=>'purple')); ?></a>
     &nbsp;<a href="javascript:void(0)" onClick="setData('<?php echo $obj['table']; ?>','repair')"><?php echo btn(array('vals'=>'修复','round'=>1,'tips'=>'修复数据表','icon'=>'wrench','scene'=>'success')); ?></a>
     &nbsp;<?php echo btn(array('vals'=>'查看','round'=>1,'tips'=>'点击查看数据','url'=>url('system/tdatalist','tb='.$obj['table']),'icon'=>'eye-open','scene'=>'info')); ?>
     &nbsp;<?php echo btn(array('vals'=>'结构','round'=>1,'tips'=>'点击查看数据结构','url'=>url('system/struct','tb='.$obj['table']),'icon'=>'cog','scene'=>'danger')); ?>
    </td>
   </tr>
   <?php endforeach; endif; else: echo "" ;endif; ?>
   <tr>
     <td height="35" align="center" valign="middle"><?php echo ckall(2); ?></td>
     <td colspan="5" align="left" valign="middle">
     &nbsp;<?php echo btn(array('vals'=>'优化','type'=>'submit','round'=>1,'tips'=>'优化数据表结构，清除索引数据','faicon'=>'repeat','scene'=>'purple')); ?>
     &nbsp;<?php echo btn(array('vals'=>'修复','type'=>'submit','round'=>1,'tips'=>'修复数据表','icon'=>'wrench','scene'=>'success')); ?>
     &nbsp;<?php echo btn(array('vals'=>'备份','type'=>'submit','round'=>1,'tips'=>'对所选数据库的数据及结构进行备份处理，备份文件在服务器内','faicon'=>'copy','scene'=>'primary')); ?>
     </td>
   </tr>
  </table>
  </form>
   <div class="alert alert-danger" style="margin:10px auto;"><?php echo icon('warning-sign'); ?> 提示，建议您定期对数据库进行备份处理，防止数据丢失,<font color="red">假设您的数据量太大，不建议在线上备份数据库！</font></div>
  </div>
 </div>
 <script type="text/javascript">
   function setData(db,act){
	  if(db!='' && act!=''){  
		 $.post( "<?php echo url('admin/setdata'); ?>", {'tables':db,'acts':act,'act':'setdata'},function(data){
			if(data==1){
				if(act=="opt"){
