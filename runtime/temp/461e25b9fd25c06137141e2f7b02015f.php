<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"D:\phpStudy\PHPTutorial\WWW\oa-device/app/bhadmin\view\system\syscompany.tpl";i:1522135206;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\common.tpl";i:1545869180;s:70:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\meta.tpl";i:1555400400;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\footer.tpl";i:1555400335;s:69:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\pic.tpl";i:1546851127;s:72:"D:\phpStudy\PHPTutorial\WWW\oa-device\app\bhadmin\view\public\editor.tpl";i:1545093518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="u-container">
 ...
 <div class="pubmain">
  ...
  <div class="btn-group">
   <?php echo btn(array('vals'=>'系统设置','size'=>3,'icon'=>'cog','round'=>1,'scene'=>'default','url'=>url('system/sysmod'))); ?>
   <?php echo btn(array('vals'=>'公司设置','size'=>3,'icon'=>'map-marker','scene'=>'primary','url'=>url('system/syscompany'))); ?>
   ...
   <?php echo btn(array('vals'=>'后台目录设置','size'=>3,'icon'=>'folder-open','round'=>1,'scene'=>'default','url'=>url('system/sysadmin'))); ?>
  ...
  <form name="sysmod" method="post" action="" onSubmit="return sysck(document.sysmod)">
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="<?php echo tabstyle(); ?>">
      <tr>
        ...
        <td height="32"><?php echo inputs(array('name'=>'companyname','place'=>'公司名称','val'=>$data['companyname'],'icon'=>'globe')); ?></td>
      </tr>
      <tr>
        <td width="132" height="32" align="right" valign="middle">　微博链接：</td>
        <td height="32"><?php echo inputs(array('name'=>'weibourl','place'=>'微博链接','val'=>$data['weibourl'],'faicon'=>'weibo')); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="32"><?php echo inputs(array('name'=>'address','place'=>'请输入地址','val'=>$data['address'],'icon'=>'map-marker')); ?></td>
      </tr>
      <tr>
        <td width="132" height="32" align="right" valign="middle">　电话：</td>
        <td height="32"><?php echo inputs(array('name'=>'tel','place'=>'电话','val'=>$data['tel'],'icon'=>'phone-alt','width'=>'20')); ?></td>
      </tr>
      <tr>
        <td width="132" height="32" align="right" valign="middle">　手机：</td>
        <td height="32"><?php echo inputs(array('name'=>'mobile','place'=>'手机','val'=>$data['mobile'],'icon'=>'phone','width'=>'20')); ?></td>
      </tr>
      <tr class="hide">
        <td width="132" height="32" align="right" valign="middle">　联系人：</td>
        <td height="32"><?php echo inputs(array('name'=>'contact','place'=>'联系人','val'=>$data['contact'],'icon'=>'user','width'=>'20')); ?></td>
      </tr>
      <tr>
        <td width="132" height="32" align="right" valign="middle">　邮箱：</td>
        <td height="32"><?php echo inputs(array('name'=>'email','place'=>'邮箱','val'=>$data['email'],'icon'=>'envelope','width'=>'20')); ?></td>
      </tr>
      <tr>
        <td width="132" height="32" align="right" valign="middle">　QQ：</td>
        <td height="32"><?php echo inputs(array('name'=>'qq','place'=>'QQ','val'=>$data['qq'],'faicon'=>'qq','width'=>'20')); ?></td>
      </tr>
      <tr>
