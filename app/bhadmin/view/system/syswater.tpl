...
<block name="main">
 <div class="pubmain">
  ...
  <div class="btn-group">
   ...
   {:btn(array('vals'=>'后台目录设置','size'=>3,'icon'=>'folder-open','scene'=>'default','round'=>1,'url'=>url('system/sysadmin')))}
  ...
  <form name="sysmod" method="post" action="" onSubmit="return sysck(document.sysmod)">
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="{:tabstyle()}">
      ...
      <tr>
        ...
        <td height="42" align="left">
         <div class="text-warning">{:icon('info-sign')} 从左到右 分别是水印字体A~I的水印样式，字体(B~G)由 THINKPHP 提供，样式生成 字体大小皆为：10px 颜色：#1ea5d7。，<font color="red">新增字体 I（中文字体,苹方）</font></div>
         <div class="waterview">
          ...
          <div data-id="8" class="waterdemo <if condition="$data['facetype'] eq 8">selected</if>"{:tooltip('字体样式I')}><img src="__img__/water/I.jpg"></div>
         </div>
        </td>
      </tr>
      <tr>
