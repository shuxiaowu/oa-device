...
<block name="main">
 <div class="pubmain">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="{:tabstyle()}">
   ...
   <tr>
     ...
     <td height="32" align="left" class="icontd">{:inputs(array('units'=>'<font color="red">选择</font>','name'=>'icon','add'=>'code','val'=>$data['icon'],'tips'=>'栏目图标','width'=>20,'place'=>'栏目图标'))}</td>
   </tr>
   <tr>
 ...
 <script type="text/javascript">
  $(document).ready(function(e) {
    $(".icontd .input-group-addon").click(function(e) {
      $("#iconmodal").modal('show');  
    });
	$(".tab-icon li").click(function(e) {
      var type = $(this).data('type');
	  var icon = $(this).data('icon');
	  if ( type == 1 ) $(".icontype input").prop('checked',false);
	  if ( type == 2 ) $(".icontype input").prop('checked',true);
	  $(".icontd .code").val(icon);
