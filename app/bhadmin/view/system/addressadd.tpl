 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
   <tr>
    ...
    <td height="32" align="left">{:inputs(array('name'=>'name','icon'=>'map-marker','val'=>'','place'=>'请填写地址名称'))}</td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">地址所属：</td>
     <td height="32" align="left">{:gaddress($did,'--')}</td>
   </tr>
   <input type="hidden" value="{$lev}" name="level">
