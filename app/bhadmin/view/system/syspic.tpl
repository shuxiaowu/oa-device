...
<block name="main">
 <div class="pubmain">
  ...
  <div class="btn-group">
       {:btn(array('vals'=>'列表模式','size'=>3,'icon'=>'th-list','scene'=>$scene[0],'round'=>1,'url'=>url('system/syspic','act=1')))}
       {:btn(array('vals'=>'图文模式','size'=>3,'icon'=>'th','scene'=>$scene[1],'url'=>url('system/syspic','act=2')))}
       {:btn(array('vals'=>'文件夹模式','size'=>3,'icon'=>'folder-open','scene'=>$scene[2],'url'=>url('system/syspic','act=3')))}
       {:btn(array('vals'=>'图片统计','size'=>3,'icon'=>'signal','scene'=>'default','round'=>1,'tips'=>'统计文件夹内上传文件大小，文件夹数量，文件数量','dir'=>'bottom','add'=>'mysignal'))}
  </div>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablev {:tabstyle()}">
   <tr class="active">
 ...
 <div style="padding:10px; box-sizing:border-box"><div class="alert alert-info">{:icon('warning-sign')} 提示，任何图片删除都无法找回，建议只删除冗余的图片！</div></div>
 </div>
</block>