        ...
        <div class="panel-body">
            <div class="u-plus btn-group">
                <if condition="$userid neq 1">
                    {:btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/traveladd')))}
                </if>
            ...
            <form name="pubserch" method="get" action="{:url('assets/travellist')}">
                ...
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
                    ...
                    <volist name="data" id="obj">
                        <tr class="maintr">
                            ...
                            <td align="center" valign="middle">{$obj['diaodu']}</td>
                            ...
                            <td align="center" valign="middle">{:showdate($obj['leavedate'])}</td>
                            <td align="center" valign="middle">{$obj['reason']}</td>
                            <td align="center" valign="middle">{$obj['route']}</td>
                            <td align="center" valign="middle">{$obj['distance']}</td>
                            <td align="center" valign="middle">{:showdate($obj['enddate'])}</td>
                            <td align="center" valign="middle">{$obj['usedep']}</td>
                            <td align="center" valign="middle">{$obj['useman']}</td>
                            <td align="center" valign="middle">{$obj['usecount']}</td>
                            <td align="center" valign="middle"><font color="red">{$obj['status']==0 ? '--' :travelstatus($obj['status'])}</font></td>
                            <td align="center" valign="middle">{$obj['paichenum']}</td>
                            <td align="center" valign="middle">{$obj['officer']}</td>
                            <if condition="$userid eq 1">
                                <td align="center" valign="middle">{$obj['adminrealname']}</td>
                            </if>
                            <td align="center" valign="middle">
                                {:btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/travelmod','id='.$obj['Id'])))}
                            </td>
                        </tr>
                    </volist>
                    <tr>
