      ...
      <form name="adminform" method="post" action="" onSubmit="return sysassets(document.adminform)">
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="table tablevh">
          <tr>
            ...
            <td width="200" align="left">{:inputs(array('name'=>'danhao','place'=>'请输入领用单号','width'=>'20'))} </td>
            <td width="120" align="right" valign="middle">领用部门<font class="addred">*</font>：</td>
            <td width="200" align="left">{:inputs(array('name'=>'branch','place'=>'请输入领用部门','width'=>'20'))} </td>
            <td width="120" align="right" valign="middle">领用人<font class="addred">*</font>：</td>
            <td align="left">{:inputs(array('name'=>'recipient','place'=>'请输入领用人','width'=>'20'))}</td>
          </tr>
          <tr>
            ...
            <td width="200" align="left">{:dropdown([['Id'=>1,'topic'=>'未领用'],['Id'=>2,'topic'=>'领用']],0,'请选择','state')}</td>
            <td width="120" align="right" valign="middle">领用时间：</td>
            <td align="left"> {:inputs(array('name'=>'lingdate','add'=>'input-date','place'=>'选择领用时间','width'=>'20'))} </td>
          </tr>
          <tr>
