        ...
        <div class="panel-body">
            <div class="u-plus btn-group">
                <if condition="$userid neq 1">
                    {:btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/qifengadd')))}
                </if>
            ...
            <form name="pubserch" method="get" action="{:url('assets/qifenglist')}">
                <div class="search">
                ...
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
                    ...
                    <volist name="data" id="obj">
                        <tr class="maintr">
                            ...
                            <td align="center" valign="middle">{$obj['qfreson']}</td>
                            ...
                            <td align="center" valign="middle">
                                {:btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/qifengmod','id='.$obj['Id'])))}
                            </td>
                        </tr>
                    </volist>
                    <tr>
