        ...
        <div class="panel-body">
            <div class="u-plus btn-group">
                <if condition="$userid neq 1">
                    {:btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/breakadd')))}
                </if>
            ...
            <form name="pubserch" method="get" action="{:url('assets/breaklist')}">
            ...
            <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)">
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
                    <tr class="active">
                        ...
                        <td width="100" align="center" valign="middle">行驶公里数(公里)</td>
                    ...
                    <volist name="data" id="obj">
                        <tr class="maintr">
                            ...
                            <td align="center" valign="middle">
                                {:btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/breakmod','id='.$obj['Id'])))}
                            </td>
                        </tr>
                    </volist>
                    <tr>
