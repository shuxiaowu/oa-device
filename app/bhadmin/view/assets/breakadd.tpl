            ...
            <form name="adminform" method="post" action="" onSubmit="return sysassets(document.adminform)">
                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="table tablevh">
                    ...
                    <tr>
                        ...
                        <td align="left">{:inputs(array('name'=>'leavedate','add'=>'input-date','val'=>datem(),'place'=>'出发日期','width'=>'20'))}
                         </td>
                    ...
                    <tr>
                        ...
                        <td align="left"> {:inputs(array('type'=>'number','name'=>'distance','place'=>'行驶公里数(公里)','width'=>'20'))} </td>
                        <td width="120" align="right" valign="middle">结束日期<font class="addred">*</font>：</td>
                        <td align="left">{:inputs(array('name'=>'enddate','add'=>'input-date','val'=>datem(),'place'=>'结束日期','width'=>'20'))}</td>
