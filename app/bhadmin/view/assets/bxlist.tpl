        ...
        <div class="panel-body">
            <div class="u-plus btn-group">
                <if condition="$userid neq 1">
                    {:btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/bxadd')))}
                </if>
            ...
            <form name="pubserch" method="get" action="{:url('assets/bxlist')}">
                ...
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
                    ...
                    <volist name="data" id="obj">
                        <tr class="maintr">
                            ...
                            <td align="center" valign="middle">{:showdate($obj['deadlinestart'])}-{:showdate($obj['deadlineend'])}</td>
                            <td align="center" valign="middle">{$obj['price']}</td>
                            <td align="center" valign="middle">{$obj['bxnum']}</td>
                            <td align="center" valign="middle">{$obj['bxname']}</td>
                            <td align="center" valign="middle"><font color="red">{$obj['isaccident']==0 ? '--':isaccident($obj['isaccident'])}</font></td>
                            <td align="center" valign="middle">{$obj['ratio']}</td>
                            <td align="center" valign="middle">{$obj['payloss']}</td>
                            <td align="center" valign="middle">{$obj['remark']}</td>
                            <if condition="$userid eq 1">
                                <td align="center" valign="middle">{$obj['adminrealname']}</td>
                            </if>
                            <td align="center" valign="middle">
                                {:btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/bxmod','id='.$obj['Id'])))}
                            </td>
                        </tr>
                    </volist>
                    <tr>
