        ...
        <div class="panel-body">
            <div class="u-plus btn-group">
                <if condition="$userid neq 1">
                    {:btn(array('vals'=>'新增','size'=>3,'scene'=>'primary','url'=>url('assets/maintainadd')))}
                </if>
            ...
            <form name="pubserch" method="get" action="{:url('assets/maintainlist')}">
                ...
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
                    ...
                    <volist name="data" id="obj">
                        <tr class="maintr">
                            ...
                            <td align="center" valign="middle">{$obj['recorder']}</td>
                            <td align="center" valign="middle">{:showdate($obj['mtdate'])}</td>
                            <td align="center" valign="middle">{$obj['mtproject']}</td>
                            <td align="center" valign="middle">{$obj['mtprice']}</td>
                            <if condition="$userid eq 1">
                             <td align="center" valign="middle">{$obj['adminrealname']}</td>
                             </if>
                            <td align="center" valign="middle">
                                {:btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('assets/maintainmod','id='.$obj['Id'])))}
                            </td>
                        </tr>
                    </volist>
                    <tr>
